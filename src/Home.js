  ...
  return (
    <div className="homepage">
      <header>
        ...
        <div className="link">
      <a href='http://127.0.0.1:5500/src/mentor.html'><button className="bt">Need guidance?</button> </a>
      <a href='http://127.0.0.1:5500/src/event.html'><button className="bt">Events</button></a>
      <a href='http://127.0.0.1:5500/src/investors.html'><button className="bt">Find your Investor</button>  </a>
      <a href='http://127.0.0.1:5500/src/newsletter.html'><button className="bt">Newsletter</button></a>
      <a href='http://127.0.0.1:5500/src/podcasts.html'><button className="bt">Podcasts</button></a>
      <a href='http://127.0.0.1:5500/src/profile.html'><button className="bt">Profile</button></a>
      <a href='http://127.0.0.1:5500/src/fund.html'><button className="bt">Companies</button></a>
      </div>
      </header>
